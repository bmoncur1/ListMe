...
class MainActivity : AppCompatActivity() {
    ...
    // }
        ...
        // set up button so user can enter a task

        val inputTextField = findViewById<EditText>(R.id.addTaskField)

        // Grab a reference to button
        // and then set onClickListener
        findViewById<Button>(R.id.button).setOnClickListener {
            // 1. grab text user has input into edittext field
            val userInputtedTask = inputTextField.text.toString()

            // 2. add string to our lists of tasks
    ...
    // 1. create a method to get data file we need
    fun getDataFile() : File {

        // every file is going to represent a specific task in our list of tasks
